      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty">
            Tenemos diferentes canales de comunicación para atenderte de la
            mejor manera según tu consulta
          </p>
        </div>
          ...
          <Card className="border-border/50">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="border-t border-border pt-3 mt-4">
                <p className="text-sm text-muted-foreground">
                  <strong>Nota:</strong> La cocina cierra 30 minutos antes del
            ...
            <CardContent className="space-y-3">
              <div>
                ...
                <p className="text-muted-foreground">
                  Salón de Fiestas El potrero, Prolongación Matamoros Sur 48
                  antes 105 Colonia, El Potrero.
                  <br />
                  Valle de Santiago, Gto. 38400
                </p>
              </div>
              <div>
                <p className="text-foreground font-medium">
